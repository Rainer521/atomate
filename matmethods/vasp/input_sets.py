...
class DeformedVaspInputSet(DictVaspInputSet):
    NSCF_SETTINGS = {"ISIF": 2, "EDIFF": 1e-6}

    ALLOWED_MODES = ["energy_convergence", "force_convergence"]

    def __init__(self, config_dict_override=None, mode="energy_convergence",
